...
#pragma endregion
    ...
    {
        std::filesystem::path skypath = "resources/textures/skybox/right.jpg";
        std::filesystem::path skypath2 = "resources/textures/skybox/left.jpg";
        std::filesystem::path skypath3 = "resources/textures/skybox/top.jpg";
        std::filesystem::path skypath4 = "resources/textures/skybox/bottom.jpg";
        std::filesystem::path skypath5 = "resources/textures/skybox/front.jpg";
        std::filesystem::path skypath6 = "resources/textures/skybox/back.jpg";
    };
